...
class Blockchain {
    ...
    //-------------------------------------------------
    //Added for project 4 - getBlockByHash
    async getBlockByHash(hash) {
      return await this.database.getBlockByHash(hash)
    }

    //-------------------------------------------------
    //Added for project 4 - getBlockByAddress
    async getBlocksByAddress(address) {
      return await this.database.getBlocksByAddress(address)
    }
