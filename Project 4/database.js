...
class Database {
    ...
    getChainFromDB() {
       ...
       //*********************************************** */
    // added for project 4 - getBlockByHash(hash)
    // get 'hash' -> make compare with block in db -> resolve 'block'
    getBlockByHash(hash) {
      let block = undefined;
      return new Promise((resolve, reject) => {
          this.db.createReadStream()
      ...
      //*********************************************** */
  // added for project 4 - getBlockByAddress(address)
  // get 'address' -> make compare with blocks in db-> resolve 'block'
