...
contract('SupplyChain', function(accounts) {
    ...
    const productNotes = "First quality eggs"
    ...
    // 1st Test
    it("Testing smart contract function collectItem() that allows a farmer to collect eggs", async() => {
        const supplyChain = await SupplyChain.deployed()

        await supplyChain.addFarmer(originFarmerID)

        // Mark an item as Collected by calling function collectItem()
        let result = await supplyChain.collectItem(UPC, originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes, {from: originFarmerID})
    ...
    // 2nd Test
    it("Testing smart contract function processItem() that allows a farmer to test eggs", async() => {
        const supplyChain = await SupplyChain.deployed()

        itemState++;
        
        let result = await supplyChain.testItem(UPC, {from: originFarmerID})
    ...
    // 3rd Test
    it("Testing smart contract function packItem() that allows a farmer to pack eggs", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 4th Test
    it("Testing smart contract function sellItem() that allows a farmer to sell eggs", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 5th Test
    it("Testing smart contract function buyItem() that allows a distributor to buy eggs", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 6th Test
    it("Testing smart contract function transportItem() that allows a distributor to transport eggs", async() => {
        const supplyChain = await SupplyChain.deployed()

        itemState++;

        let result = await supplyChain.transportItem(UPC, {from: distributorID})
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State')
        truffleAssert.eventEmitted(result, 'Transported');
    })

    // 7th Test
    it("Testing smart contract function receiveItem() that allows a retailer to mark eggs received", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 8th Test
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase eggs", async() => {
        const supplyChain = await SupplyChain.deployed()
