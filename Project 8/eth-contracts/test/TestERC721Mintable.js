...
contract('TestERC721Mintable', accounts => {
    ...
    describe('match erc721 spec', function () {
        ...
        it('Test 1: should return total supply', async function () { 
            let total = await this.contract.totalSupply();
            assert.equal(total, 8, "The totalSupply should be 8");
        })

        it('Test 2: should get token balance', async function () { 
        ...
        it('Test 3: token uri should be complete', async function () { 
        ...
        it('Test 4: should transfer token from one owner to another', async function () { 
            let tokenId=1;
    ...
    describe('Ownership properties......', function () {
        ...
        it('Test 5: should fail when minting when address is not contract owner', async function () { 
            let failed = false;
            try {
        ...
        it('Test 6: should return contract owner', async function () { 
