...
//  4) create 'whenNotPaused' & 'paused' modifier that throws in the appropriate situation
    ...
    modifier paused()
    {
        require(_paused, "This contract is not currently paused");
        _;
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Destination address cannot be the current owner." );

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender), "Now allowed to approve addresses");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "That tokenId already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "From parameter must be the owner of the tokenId");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint tokenId) internal {
        require(_exists(tokenId), "This tokenID was not found.");
...
contract ERC721MintableComplete is ERC721Metadata("Complete Mintable Blockchain Token", "CMBT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
